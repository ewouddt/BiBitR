...
public class biclustering {
	...
	public static void main(String[] args) throws Exception {
		...
		// PARAMETER 10: Search for subpatterns, yes or no
		String Ssubpat=args[9];
		Integer Dsubpat=new Integer(Ssubpat);
		int subpat=Dsubpat.intValue();
        ...
        for(int i=max;i>=1;i--)
        {
        	...
        	int num=Utilities.generateBiclusters(matrix_Aux,minMot,minGene,distance,outFile,i,Genes,Rows,patternSize,write,noise,subpat); //PVALUE CHANGE
